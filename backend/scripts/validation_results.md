...
- Repositories/events evaluated: 37
- Comparable events: 30
- Sign agreement: 17/30 (57%)
...
| markupsafe | Architecture modularization | steady | coupling_down | unknown | approximate | 0.57 |
| markupsafe | Architecture modularization | coupling_down | coupling_up | False | approximate | 0.90 |
| markupsafe | Tests dependency expansion | steady | coupling_up | unknown | approximate | 0.66 |
| markupsafe | Architecture modularization | coupling_up | coupling_up | True | approximate | 0.90 |
...
| python-dotenv | Test Cli becomes dependency hub | coupling_up | coupling_up | True | approximate | 1.00 |
| python-dotenv | Setup becomes dependency hub | coupling_up | coupling_up | True | approximate | 1.00 |
| python-dotenv | Setup architectural shift | coupling_up | coupling_up | True | approximate | 1.00 |
| python-dotenv | Architecture modularization | coupling_down | coupling_up | False | approximate | 1.00 |
| python-dotenv | Setup becomes dependency hub | coupling_up | coupling_up | True | approximate | 1.00 |
...
| flask-cors | Flask Cors dependency expansion | coupling_up | coupling_down | False | approximate | 0.99 |
...
| flask-cors | Flask Cors becomes dependency hub | coupling_up | coupling_down | False | approximate | 0.99 |
| prettytable | Architecture modularization | coupling_down | coupling_down | True | approximate | 0.97 |
| prettytable | Prettytable coupling reduction | coupling_down | coupling_down | True | approximate | 0.97 |
| prettytable | Prettytable becomes dependency hub | coupling_up | coupling_down | False | approximate | 0.97 |
| prettytable | Prettytable architectural shift | steady | coupling_down | unknown | approximate | 0.72 |
| prettytable | Prettytable architectural shift | steady | coupling_down | unknown | approximate | 0.28 |
| prettytable | Prettytable architectural shift | coupling_up | coupling_up | True | approximate | 0.97 |
| prettytable | Prettytable dependency expansion | coupling_up | coupling_down | False | approximate | 0.97 |
| prettytable | Architecture modularization | coupling_down | coupling_up | False | approximate | 0.97 |
| prettytable | Architecture modularization | steady | coupling_down | unknown | exact | 0.97 |
